        ...
        <>
            ...
            <section className="bg-gray-900 py-16 text-white md:py-20">
                <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 md:grid-cols-[1.15fr_1fr] md:items-center">
                    <div>
                        <p className="text-sm font-bold uppercase tracking-[0.2em] text-blue-300">Built for everyday business</p>
                        ...
                        <p className="mt-5 max-w-xl leading-7 text-gray-300">
                            Bookkeeping gives you a simple daily record of your money, so you can make decisions with confidence.
                        </p>
                    </div>

                    <div className="grid gap-4 sm:grid-cols-3 md:grid-cols-1">
                        {benefits.map((benefit) => (
                            <div key={benefit.value} className="rounded-xl border border-gray-700 bg-gray-800 p-5">
                                <p className="text-xl font-bold text-white">{benefit.value}</p>
                                <p className="mt-1 text-sm leading-6 text-gray-300">{benefit.label}</p>
                            </div>
                        ))}
                    </div>
                </div>
